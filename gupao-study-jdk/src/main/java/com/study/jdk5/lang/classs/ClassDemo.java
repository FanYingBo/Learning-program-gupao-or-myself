package com.study.jdk5.lang.classs;
...
public class ClassDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            Class<?> aClass = classLoader.loadClass("com.study.jdk5.lang.classs.Foo");
...
//            e.printStackTrace();
        ...
        System.out.println("-----------------------");
        try {
            Class<?> clazz = Class.forName("com.study.jdk5.lang.classs.Foo");
            Class<?> calzzs = Class.forName("com.study.jdk5.lang.classs.Foo",true,classLoader);
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
